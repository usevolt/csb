...
#define CONFIG_CANOPEN_RXPDO1_ID					(CANOPEN_TXPDO2_ID + ESB_NODE_ID)
...
#define CONFIG_CANOPEN_RXPDO1_MAPPING2_MAIN_INDEX	CSB_ESB_OIL_TEMP_INDEX
#define CONFIG_CANOPEN_RXPDO1_MAPPING2_SUB_INDEX	CSB_ESB_OIL_TEMP_SUBINDEX
#define CONFIG_CANOPEN_RXPDO1_MAPPING2_LEN			CANOPEN_TYPE_LEN(CSB_ESB_OIL_TEMP_TYPE)
...
#define CONFIG_CANOPEN_RXPDO2_ID					(CANOPEN_TXPDO3_ID + LKEYPAD_NODE_ID)
...
#define CONFIG_CANOPEN_RXPDO2_MAPPING1_LEN			CANOPEN_TYPE_LEN(KEYP_BUTTON1_TYPE)
#define CONFIG_CANOPEN_RXPDO2_MAPPING2_MAIN_INDEX	CSB_WIPER_REQ_INDEX
#define CONFIG_CANOPEN_RXPDO2_MAPPING2_SUB_INDEX	CSB_WIPER_REQ_SUBINDEX
#define CONFIG_CANOPEN_RXPDO2_MAPPING2_LEN			CANOPEN_TYPE_LEN(KEYP_BUTTON2_TYPE)
#define CONFIG_CANOPEN_RXPDO2_MAPPING3_MAIN_INDEX	0
#define CONFIG_CANOPEN_RXPDO2_MAPPING3_SUB_INDEX	0
#define CONFIG_CANOPEN_RXPDO2_MAPPING3_LEN			CANOPEN_TYPE_LEN(KEYP_BUTTON3_TYPE)
#define CONFIG_CANOPEN_RXPDO2_MAPPING4_MAIN_INDEX	0
#define CONFIG_CANOPEN_RXPDO2_MAPPING4_SUB_INDEX	0
#define CONFIG_CANOPEN_RXPDO2_MAPPING4_LEN			CANOPEN_TYPE_LEN(KEYP_BUTTON4_TYPE)
#define CONFIG_CANOPEN_RXPDO2_MAPPING5_MAIN_INDEX	0
#define CONFIG_CANOPEN_RXPDO2_MAPPING5_SUB_INDEX	0
#define CONFIG_CANOPEN_RXPDO2_MAPPING5_LEN			CANOPEN_TYPE_LEN(KEYP_BUTTON5_TYPE)
