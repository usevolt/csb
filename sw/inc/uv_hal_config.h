...
#define CONFIG_CANOPEN_TXPDO1_MAPPING1_MAIN_INDEX	CSB_WIPER_SPEED_INDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING1_SUB_INDEX	CSB_WIPER_SPEED_SUBINDEX
#define CONFIG_CANOPEN_TXPDO1_MAPPING1_LEN			CANOPEN_TYPE_LEN(CSB_WIPER_SPEED_TYPE)
